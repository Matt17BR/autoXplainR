...
This record covers the source tree prepared for AutoXplainR 0.4.0. It is kept
...
- The package contains no vendored third-party source tree, compiled binary,
  embedded model, or bundled external data set. Examples and tests refer to
  standard R data such as `mtcars` and `iris` or construct data at runtime.
