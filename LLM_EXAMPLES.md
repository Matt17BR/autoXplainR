...
This example generates a narrative from the evidence produced by the
installed package. It requires no API key or network request:
...
optional generated wording. Historical provider responses are not
presented here as evidence that an endpoint or model is currently
available.
