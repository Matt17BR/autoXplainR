...
Advanced users may supply their own split, model, prediction function, H2O
AutoML run, explanation configuration, or narrative provider.
...
1. **Guided:** what was fitted, whether it beats a simple baseline, the most
   important patterns, and concrete cautions.
2. **Evidence:** permutation variability, dependence, supplied-model
   multiplicity, ALE/PDP support, and provenance.
3. **Developer:** repeat-level values, prediction contracts, recipes, metrics,
