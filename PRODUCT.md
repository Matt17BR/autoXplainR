...
fitting are different and must have different labels. Automatically
selected feature summaries remain descriptive. Language-model prose is
optional and cannot override numerical results.
