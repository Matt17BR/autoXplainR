...
convenience, not a restriction on inspecting evidence. Lower-level functions
accept existing models through a documented prediction contract.
...
to established R packages. See [the development plan](ROADMAP.md) for architecture,
feature proposals, acceptance tests and the evidence required for that claim.
