...
AutoXplainR 0.6.1 improves report layout, model-selection inspection and cost
comparisons, including a drawn Pareto frontier. This is a preparation note, not
...
are recorded in `validation/release-0.6.1.md`. Historical checks remain in
`validation/release-0.6.0.md` and do not establish anything about the new archive.
